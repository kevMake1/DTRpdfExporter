...
{
    public class BillOfLandingVM : INotifyPropertyChanged
    {
        ...
        public ExportCommand2 exportCommand { get; set; }
        ...
        public BillOfLandingVM()
        {
            printCommand = new PrintCommand(this);
            exportCommand = new ExportCommand2(this);
